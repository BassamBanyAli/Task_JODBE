...
namespace Task_JODBE.Controllers
{
    public class AdminUsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AdminID,Email,password,passwordHash,passwordSalt,CreatedAt")] AdminUser adminUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AdminID,Email,password,passwordHash,passwordSalt,CreatedAt")] AdminUser adminUser)
        {
            if (ModelState.IsValid)
            {
